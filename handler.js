          ...
          for (let user of participants) {
            ...
            try {
              ...
              let wel = await new knights.Welcome()
                ...
                .setAvatar(pp)
                .setBackground("https://express-uploader.dapitt.repl.co/file/LFyEhFrZWZNc.jpg")
                .toAttachment()
...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    ...
    mods: '*Anda Moderator?*',
    premium: '*Jadi User Premium Dong..*',
    group: '*Pakai Ini Di Grup*',
  ...
  let botAdmin = {
    botAdmin: 'Mikir dikit lah bang *BOT NYA BUKAN ADMIN*',
  }[type]
